...
}else if(isset($_REQUEST["showless"])===true){
        ...
        <div class="bg-white shadow rounded overflow-hidden">
            ...
            <div class="py-4 px-3">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <h5 class="mb-0">Recent Captures</h5><a href="?showless" class="btn btn-link text-blue"><u>Show Less</u></a>
                </div>
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-2 pr-lg-1"><img src="images\5.png" alt="" class="img-fluid rounded shadow-sm"></div>              
                    <div class="col-lg-6 mb-2 pl-lg-1"><img src="images\6.png" alt="" class="img-fluid rounded shadow-sm"></div>                
                    <div class="col-lg-6 pr-lg-1 mb-2"><img src="images\7.png" alt="" class="img-fluid rounded shadow-sm"></div>
                    <div class='col-lg-6 pl-lg-1'><img src='images\8.png' alt="" class="img-fluid rounded shadow-sm"></div>
                    <div class="col-lg-6 mb-2 pr-lg-1"><img src="images\9.png" alt="" class="img-fluid rounded shadow-sm"></div>              
                    <div class="col-lg-6 mb-2 pl-lg-1"><img src="images\10.png" alt="" class="img-fluid rounded shadow-sm"></div>                
                    <div class="col-lg-6 pr-lg-1 mb-2"><img src="images\11.png" alt="" class="img-fluid rounded shadow-sm"></div>
                    <div class='col-lg-6 pl-lg-1'><img src='images\12.png' alt="" class="img-fluid rounded shadow-sm"></div>
